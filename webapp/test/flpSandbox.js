		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Multi Editable ",
									"targetURL": "#idmultizmultiedit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idmultizmultiedit-display": {
								"semanticObject": "idmultizmultiedit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idmulti.zmultiedit",
									"url": sap.ui.require.toUrl("idmulti/zmultiedit")
								}
							}
						}
					}
